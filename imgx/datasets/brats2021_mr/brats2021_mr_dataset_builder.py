...
from imgx.datasets.preprocess import clip_and_normalise_intensity_3d
from imgx.datasets.save import save_uids
...
class BRATS2021MRDatasetInfo(DatasetInfo):
...
BRATS2021_MR_INFO = BRATS2021MRDatasetInfo(
    name="brats2021_mr",
