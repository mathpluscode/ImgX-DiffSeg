...
from imgx.diffusion_segmentation.diffusion_step import get_loss_logits_metrics
from imgx.diffusion_segmentation.train_state import TrainState
...
def get_recycling_loss_step(
    ...
    [chex.ArrayTree, chex.ArrayTree, jax.random.KeyArray],
    ...
    def loss_step(
        ...
        key_t, key_noise_re, key_noise = jax.random.split(key=key, num=3)
