...
class Diffusion(hk.Module):
    ...
    ABCMeta is needed so that W0223 will not be raised, if sample() is not
    defined.
    https://stackoverflow.com/questions/71902156/why-we-declare-metaclass-abc-abcmeta-when-use-abstract-class-in-python
    """
    ...
    def __init__(
        ...
        Args:
            model: model to be used for diffusion.
            num_timesteps: number of diffusion steps.
            noise_fn: a function that gets noise given a shape.
        """
        super().__init__()
        self.model = model
