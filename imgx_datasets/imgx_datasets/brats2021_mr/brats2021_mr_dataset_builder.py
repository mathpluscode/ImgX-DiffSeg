...
BRATS2021_MR_INFO = BRATS2021MRNestedDatasetInfo(
    tfds_preprocessed_dir=TFDS_MANUAL_DIR
    / BRATS2021_MR_TFDS_FOLD
    / "preprocessed",
...
def load_and_preprocess_brats_image_and_label(
    ...
    label_volume = sitk.Crop(
        label_volume, BRATS2021_MR_CROP_LOWER, BRATS2021_MR_CROP_UPPER
    )
    ...
    for modality in BRATS2021_MR_MODALITIES:
        ...
        # crop
        image_volume = sitk.Crop(
            image_volume, BRATS2021_MR_CROP_LOWER, BRATS2021_MR_CROP_UPPER
        )
...
class Builder(
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        ...
        return tfds.core.DatasetInfo(
            ...
            homepage="https://www.kaggle.com/datasets/dschettler8845/brats-2021-task1",  # noqa: E501, pylint: disable=line-too-long
            citation=_CITATION,
        )
    ...
    def _split_generators(
        ...
        preprocessed_dir = (
            dl_manager.manual_dir / BRATS2021_MR_TFDS_FOLD / "preprocessed"
        )
        ...
        valid_uids = uids[
            BRATS2021_MR_NUM_TRAIN_IMAGES:-BRATS2021_MR_NUM_TEST_IMAGES
        ]
    ...
    def _generate_examples(
        ...
        for uid in uids:
            ...
            image_path_dict = {}
            for modality in BRATS2021_MR_MODALITIES:
                image_path_dict[modality] = (
                    data_dir / uid / f"{uid}_{modality}.nii.gz"
                )
